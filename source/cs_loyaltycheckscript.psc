...
Function SetUpInitialJarlLoyalties()
	...
	if (AllHoldings.GetAt(0) as GlobalVariable).GetValueInt() == 11
		(AllLocations.GetAt(0) as Location).SetKeywordData(JarlLoyalty, 70)
	elseif (AllHoldings.GetAt(0) as GlobalVariable).GetValueInt() == 12
		(AllLocations.GetAt(0) as Location).SetKeywordData(JarlLoyalty, 30)
	endif

	if (AllHoldings.GetAt(1) as GlobalVariable).GetValueInt() == 12
		(AllLocations.GetAt(1) as Location).SetKeywordData(JarlLoyalty, 70)
	elseif (AllHoldings.GetAt(1) as GlobalVariable).GetValueInt() == 11
		(AllLocations.GetAt(1) as Location).SetKeywordData(JarlLoyalty, 30)
	endif

	if (AllHoldings.GetAt(2) as GlobalVariable).GetValueInt() == 11
		(AllLocations.GetAt(2) as Location).SetKeywordData(JarlLoyalty, 70)
	elseif (AllHoldings.GetAt(2) as GlobalVariable).GetValueInt() == 12
		(AllLocations.GetAt(2) as Location).SetKeywordData(JarlLoyalty, 30)
	endif

	if (AllHoldings.GetAt(3) as GlobalVariable).GetValueInt() == 11
		(AllLocations.GetAt(3) as Location).SetKeywordData(JarlLoyalty, 70)
	elseif (AllHoldings.GetAt(3) as GlobalVariable).GetValueInt() == 12
		(AllLocations.GetAt(3) as Location).SetKeywordData(JarlLoyalty, 30)
	endif

	if (AllHoldings.GetAt(4) as GlobalVariable).GetValueInt() == 12
		(AllLocations.GetAt(4) as Location).SetKeywordData(JarlLoyalty, 70)
	elseif (AllHoldings.GetAt(4) as GlobalVariable).GetValueInt() == 11
		(AllLocations.GetAt(4) as Location).SetKeywordData(JarlLoyalty, 30)
	endif

	if (AllHoldings.GetAt(5) as GlobalVariable).GetValueInt() == 12
		(AllLocations.GetAt(5) as Location).SetKeywordData(JarlLoyalty, 70)
	elseif (AllHoldings.GetAt(5) as GlobalVariable).GetValueInt() == 11
		(AllLocations.GetAt(5) as Location).SetKeywordData(JarlLoyalty, 30)
	endif

	if (AllHoldings.GetAt(6) as GlobalVariable).GetValueInt() == 11
		(AllLocations.GetAt(6) as Location).SetKeywordData(JarlLoyalty, 70)
	elseif (AllHoldings.GetAt(6) as GlobalVariable).GetValueInt() == 12
		(AllLocations.GetAt(6) as Location).SetKeywordData(JarlLoyalty, 30)
	endif

	if (AllHoldings.GetAt(7) as GlobalVariable).GetValueInt() == 11
		(AllLocations.GetAt(7) as Location).SetKeywordData(JarlLoyalty, 70)
	elseif (AllHoldings.GetAt(7) as GlobalVariable).GetValueInt() == 12
		(AllLocations.GetAt(7) as Location).SetKeywordData(JarlLoyalty, 30)
	endif

	if (AllHoldings.GetAt(8) as GlobalVariable).GetValueInt() == 12
		(AllLocations.GetAt(8) as Location).SetKeywordData(JarlLoyalty, 70)
	elseif (AllHoldings.GetAt(8) as GlobalVariable).GetValueInt() == 11
		(AllLocations.GetAt(8) as Location).SetKeywordData(JarlLoyalty, 30)
	endif
