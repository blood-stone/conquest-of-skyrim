...
Function SetUp()
    ...
    if FortGarrison.GetSize() == 0 && Game.GetPlayer().IsInLocation(Fort.GetLocation()) == 0
        ...
        AttackersInitial = 20*(TMDataScript.TMData.GetKeywordData(TMDataScript.AttackingArmies) as int)
...
Function WinQuest()
    ...
    TMDataScript.TMData.SetKeywordData(TMDataScript.WarPriority, -1)
    TMDataScript.TMData.SetKeywordData(TMDataScript.AttackingArmies, 0)
    SetStage(20)
EndFunction
