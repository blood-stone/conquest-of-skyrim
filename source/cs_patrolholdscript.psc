...
Function FireCommander(Actor Citizen)
    ...
    (RecruitCommanders.GetAt(armynum) as GlobalVariable).SetValue(1)
...
Function RecruitCommander(Actor Citizen, int armynum)
    ...
    (RecruitCommanders.GetAt(armynum) as GlobalVariable).SetValue(0)
    Commanders[armynum].GetActorRef().AddToFaction(CommanderFaction)
    Commanders[armynum].GetActorRef().SetActorValue("Confidence", 4)
    Commanders[armynum].GetActorRef().SetActorValue("Aggression", 1)
    Commanders[armynum].GetActorRef().SetActorValue("Assistance", 1)
    ArmyScripts[armynum].CurrentTask = TaskBarrelNoOrder
