...
Scriptname CS__TIF__05AF7102 Extends TopicInfo Hidden
...
AttackPlanningScript.InvasionTarget.ForceLocationTo(AttackPlanningScript.AllLocationsCampSons.GetAt(holdnum) as Location)
AttackPlanningScript.holdnum = holdnum
AttackPlanningScript.enemyfactionnum = 12
