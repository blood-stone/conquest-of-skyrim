...
Scriptname CS__TIF__05AF1FD9 Extends TopicInfo Hidden
...
AttackPlanningScript.InvasionTarget.ForceLocationTo(AttackPlanningScript.AllLocations.GetAt(holdnum) as Location)
AttackPlanningScript.holdnum = holdnum
AttackPlanningScript.enemyfactionnum = (AttackPlanningScript.AllHoldings.GetAt(holdnum) as GlobalVariable).GetValueInt()
