...
Scriptname CS_QF__05077332 Extends Quest Hidden
...
endwhile
int guardnum = 0
while guardnum < 3*BarracksLevel.GetValue()
	ObjectReference GuardVillage1 = GuardsVillage1.GetAt(guardnum) as ObjectReference
...
Quest[] Property DefendQuestInMainHold  Auto  
...
ObjectReference[] Property TriggerBoxesInMainHold  Auto  
