...
Scriptname CS_QF__0509FBAE Extends Quest Hidden
...
debug.trace("Door unlocked")
JailActivator.disable()
debug.trace("Jail Activator disabled")
SetObjectiveCompleted(12)
debug.trace("Setting stage to 10")
SetStage(10)
;END CODE
EndFunction
;END FRAGMENT
...
ObjectReference Property JailActivator  Auto  
