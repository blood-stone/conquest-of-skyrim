Scriptname CS_FactionWarStrategicPlan extends MiscObject
...
int Property Spread Auto ;0 = Use all offensive units in one operation, 5 = Use multiple operations with one offensive unit each
