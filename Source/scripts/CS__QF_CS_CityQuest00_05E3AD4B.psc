...
Scriptname CS__QF_CS_CityQuest00_05E3AD4B Extends Quest Hidden
...
;BEGIN ALIAS PROPERTY Worker
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_Worker Auto
;END ALIAS PROPERTY
...
Alias_Worker.GetActorRef().SetRelationshipRank(Game.GetPlayer(), 1)
SetObjectiveCompleted(20)
kmyQuest.ChangeGroupInfluence("Commoners", 5)
kmyQuest.ChangeGroupInfluence("Nobility", -5)
