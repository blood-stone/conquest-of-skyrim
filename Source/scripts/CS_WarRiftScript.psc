...
Scriptname CS_WarRiftScript Extends Quest Hidden
...
EnemyJarlKid1.ForceRefTo(Alias_JarlKid1.GetActorRef())
EnemyJarlKid2.ForceRefTo(Alias_JarlKid2.GetActorRef())
StopCombat.disable()
JarlDoor.Lock(false)
JailDoor.Lock(false)
...
Function Fragment_0()
;BEGIN AUTOCAST TYPE CS_WarRiftAttack
Quest __temp = self as Quest
CS_WarRiftAttack kmyQuest = __temp as CS_WarRiftAttack
;END AUTOCAST
;BEGIN CODE
Faction04.SetPlayerEnemy(true)
Faction04.SetEnemy(Faction01)
Alias_JarlKid1.ForceRefTo(Saerlund)
Alias_JarlKid2.ForceRefTo(Harrald)
...
ObjectReference Property GuardMarker3  Auto  

ObjectReference Property GuardMarker4  Auto  

ObjectReference Property JarlDoor  Auto  
