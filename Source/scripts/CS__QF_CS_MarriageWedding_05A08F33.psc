...
Alias_Steward.TryToMoveTo(Alias_WitnessSpot006.GetRef())
Alias_Jarl.TryToMoveTo(Alias_WitnessSpot006.GetRef())
...
Alias_Spouse.GetActorReference().AddtoFaction(PotentialMarriageFaction)
...
RelationshipMarriageFINKeyword.SendStoryEventAndWait(akRef1 = Alias_Spouse.GetActorRef())
...
RelationshipMarriageFIN.SetStage(20)
...
Game.GetPlayer().MoveTo(Alias_PlayerSpot.GetRef())
