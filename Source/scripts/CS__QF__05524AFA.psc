...
Scriptname CS__QF__05524AFA Extends Quest Hidden
...
elseif Alias_DungeonCleared.GetLocation() != None
	Alias_BossContainerCleared.GetRef().AddItem(Alias_QuestItem.GetRef())
	kmyQuest.QuestContainer = Alias_BossContainer
	Alias_MapMarkerCleared.GetRef().enable()
	SetObjectiveDisplayed(1)
else
	debug.notification("Your mage could not find a location for a Dwemer Schematic, come back later")
endif
;END CODE
EndFunction
;END FRAGMENT
